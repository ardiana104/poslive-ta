...
(function () {
  ...
  var flatpickrDate = $('.flatpickr-date'),
    ...
    flatpickrDateTime = $('.flatpickr-datetime'),
    flatpickrMulti = $('.flatpickr-multi'),
    flatpickrRange = $('.flatpickr-range'),
    flatpickrInline = $('.flatpickr-inline'),
    flatpickrFriendly = $('.flatpickr-human-friendly'),
    flatpickrDisabledRange = $('.flatpickr-disabled-range');
