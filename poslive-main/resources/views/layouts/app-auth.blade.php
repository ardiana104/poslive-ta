...
<head>
    ...
    <title>Login | Kopi Mustika Bali</title>
    ...
    <link rel="stylesheet" href="{{asset('admin/vendor/libs/@form-validation/umd/styles/index.min.css')}}" />
...
<body>
    ...
    <script src="{{asset('admin/vendor/libs/@form-validation/umd/bundle/popular.min.js')}}"></script>
    <script src="{{asset('admin/vendor/libs/@form-validation/umd/plugin-bootstrap5/index.min.js')}}"></script>
    <script src="{{asset('admin/vendor/libs/@form-validation/umd/plugin-auto-focus/index.min.js')}}"></script>
