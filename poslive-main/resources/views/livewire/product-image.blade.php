    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="imageProductFormLabel">Update Foto Produk</h5>
                ...
                <form>
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <button wire:click.prevent="updateProductImage()" class="btn btn-secondary btn-block">UPDATE</button>
                        </div>
                    </div>
                </form>
            </div>
