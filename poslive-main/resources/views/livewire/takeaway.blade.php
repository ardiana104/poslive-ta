            ...
            <div class="card">
                ...
                <div class="card-body px-0 py-0" style="max-width:100%;height:75vh;overflow-x:hidden;">
                    <div class="row px-3">
                        ...
                        @if($product->status == 'active' && $product->idmetode == 2)
                        <div class="col-sm-3 px-0 py-0 dinein">
                            <div type="button" class="card px-0 py-0" wire:click="addItem({{$product->id}})">
                                <div class="card-header bg-dark d-flex px-1 py-1" style="opacity:0.8;">
                                    <div class="col-sm text-center text-white font-weight-bold justify-content-center prodprice">{{ idr($product->harga) }}<br>
                                        <small class="prodstock">Stok : {{$product->stok}}</small>
                                    </div>
                                </div>
                                <div class="card-body px-0 py-0">
                                    <div class="ovl-container">
                                        <img src="{{asset('storage/uploads/'.$product->gambar)}}" alt="Product Image" class="img-fluid px-0 py-0">
                                        <div class="ovl">
                                ...
                                <div class="card-footer bg-danger px-1 py-1">
                                    <div class="col-sm d-flex text-white font-weight-bold justify-content-center prodname">{{$product->nama}}</div>
                                    <div class="col-sm-12 d-flex text-white justify-content-between px-2 prodname">
                                        @if($search == '')
                                        <small>{{$product->category->nama}}</small>
                                        @else
                                        <small class="font-weight-bold text-warning">{{$product->category->nama}}</small>
                                        @endif
                                        @if($search == '')
                                        <small>{{$product->option->nama}}</small>
                                        @else
                                        <small class="font-weight-bold text-info">{{$product->option->nama}}</small>
                                        @endif
                ...
                <div class="card-body px-0 py-0" style="overflow-y:scroll;height:42vh;">
                    <table class="table table-sm text-secondary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <img src="#" alt="BCA" class="img-fluid px-0 py-0" style="height:24px;">
                                </td>
                                <td>
                                    <img src="#" alt="BNI" class="img-fluid px-0 py-0" style="height:24px;">
                                </td>
                                <td>
                                    <img src="#" alt="DANA" class="img-fluid px-0 py-0" style="height:24px;">
                                </td>
                                <td>
                                    <img src="#" alt="GOPAY" class="img-fluid px-0 py-0" style="height:24px;">
                                </td>
                                <td>
                                    <img src="#" alt="QRIS" class="img-fluid px-0 py-0" style="height:24px;">
                                </td>
                                <td>
                                    <img src="#" alt="LINKAJA" class="img-fluid px-0 py-0" style="height:24px;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="1" class="text-center text-secondary">
                                    <img src="#" alt="GPN" class="img-fluid px-0 py-0" style="height:24px;"><br>
                                </td>
                                <td colspan="1" class="text-center text-secondary">
                                    <img src="#" alt="QRIS" class="img-fluid px-0 py-0" style="height:24px;">
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="text-center text-secondary">
                                    <img src="#" alt="QRIS" class="img-fluid px-0 py-0 mt-2 mb-2" style="height:125px;">
                                </td>
                            </tr>
                            @endforelse
